...
document.head.innerHTML='<title>Bavalt</title><meta name="viewport" content="width=1200, height=device-height, initial-scale=0.8, maximum-scale=1.0, user-scalable=no">';
