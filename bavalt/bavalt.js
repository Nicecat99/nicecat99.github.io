...
document.head.innerHTML='<title>Bavalt</title><meta name="viewport" content="width=100, height=device-height, initial-scale=0.9, maximum-scale=1.0, user-scalable=no">';
